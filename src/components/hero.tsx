...
export function Hero() {
    ...
    const socialLinks = [
        { href: socials.github, icon: Github, label: "GitHub", color: "text-white" },
        { href: socials.linkedin, icon: Linkedin, label: "LinkedIn", color: "text-[#0077b5]" },
        { href: socials.instagram, icon: Instagram, label: "Instagram", color: "text-[#e4405f]" },
        { href: `https://discord.com/users/559173897984147458`, icon: DiscordIcon, label: "Discord", color: "text-[#5865f2]" },
        { href: socials.leetcode, icon: LeetCodeIcon, label: "LeetCode", color: "text-[#ffa116]" },
        { href: socials.spotify, icon: Music, label: "Spotify", color: "text-[#1db954]" },
    ];
                        ...
                        <div>
                            ...
                            <div className="grid grid-cols-2 gap-4 mb-8">
                                {socialLinks.map((social) => (
                                    ...
                                    >
                                        <social.icon size={20} className="transition-all" />
